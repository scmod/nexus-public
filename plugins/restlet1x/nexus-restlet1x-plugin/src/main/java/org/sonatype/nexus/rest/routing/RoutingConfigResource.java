...
/**
 * Autorouting Configuration REST resource, usable only on Maven Proxy
 * repositories.
 *
 * @author cstamas
 * @since 2.4
...
public class RoutingConfigResource extends RoutingResourceSupport {
	/**
	 * REST resource URI.
	 */
	public static final String RESOURCE_URI = "/repositories/{"
			+ REPOSITORY_ID_KEY + "}/routing/config";
	...
	public PathProtectionDescriptor getResourceProtection() {
		return new PathProtectionDescriptor("/repositories/*/routing/config",
	...
	@Override
	@GET
	public RoutingConfigMessageWrapper get(final Context context,
		...
		final DiscoveryConfig config = getManager().getRemoteDiscoveryConfig(
		...
		payload.setDiscoveryIntervalHours(Ints
