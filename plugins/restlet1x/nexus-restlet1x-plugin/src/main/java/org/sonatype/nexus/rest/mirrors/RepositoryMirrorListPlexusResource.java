...
public class RepositoryMirrorListPlexusResource extends
		AbstractRepositoryMirrorPlexusResource {
	public static final String RESOURCE_URI = "/repository_mirrors/{"
			+ REPOSITORY_ID_KEY + "}";
	...
	public PathProtectionDescriptor getResourceProtection() {
		return new PathProtectionDescriptor("/repository_mirrors/*",
				"authcBasic,perms[nexus:repositorymirrors]");
	}
	...
	public Object get(Context context, Request request, Response response,
		...
		try {
			...
			throw new ResourceException(Status.CLIENT_ERROR_BAD_REQUEST,
					"Invalid repository id " + getRepositoryId(request), e);
		}
	...
	public Object post(Context context, Request request, Response response,
		...
		try {
			List<MirrorResource> resources = (List<MirrorResource>) ((MirrorResourceListRequest) payload)
					.getData();
