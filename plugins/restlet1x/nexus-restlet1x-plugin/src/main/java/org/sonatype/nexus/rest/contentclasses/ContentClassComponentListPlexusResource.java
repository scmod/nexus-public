...
public class ContentClassComponentListPlexusResource extends
	...
	@Inject
	public ContentClassComponentListPlexusResource(
	...
	public PathProtectionDescriptor getResourceProtection() {
		return new PathProtectionDescriptor(getResourceUri(),
				"authcBasic,perms[nexus:componentscontentclasses]");
	}
	...
	/**
	 * Retrieve the list of content classes availabe in nexus. Plugins can
	...
	public Object get(Context context, Request request, Response response,
		...
		for (ContentClass contentClass : repoTypeRegistry.getContentClasses()
				.values()) {
			...
			for (String compClass : repoTypeRegistry
					.getCompatibleContentClasses(contentClass)) {
