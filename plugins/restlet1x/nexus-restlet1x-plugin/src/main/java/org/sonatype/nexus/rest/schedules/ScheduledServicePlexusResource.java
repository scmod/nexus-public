...
public class ScheduledServicePlexusResource extends
	...
	public PathProtectionDescriptor getResourceProtection() {
		return new PathProtectionDescriptor("/schedules/*",
		...
		if (serviceRequest != null) {
			...
			try {
				...
				if (TaskState.RUNNING.equals(state)
						|| TaskState.CANCELLING.equals(state)
				...
				for (Iterator<ScheduledServicePropertyResource> iter = resource
						.getProperties().iterator(); iter.hasNext();) {
				...
				getLogger().warn(
						"Unable to locate task id:" + resource.getId(), e);
