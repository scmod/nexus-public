...
public class EnumUtil {
	...
	private static <E> PlexusResourceException validationError(String name,
			Class<E> enumClass) {
		...
		return new PlexusResourceException(Status.CLIENT_ERROR_BAD_REQUEST,
				"Configuration error.", ner);
	}
