...
public final class RoleAndPrivilegeListResourceComparator implements
		Comparator<RoleAndPrivilegeListResource> {
	...
	public int compare(RoleAndPrivilegeListResource o1,
			RoleAndPrivilegeListResource o2) {
		// always sort by roles first, then privileges
		if (o1.getType().equals("role") && o2.getType().equals("privilege")) {
			return -1;
		} else if (o1.getType().equals("privilege")
				&& o2.getType().equals("role")) {
			return 1;
		}
