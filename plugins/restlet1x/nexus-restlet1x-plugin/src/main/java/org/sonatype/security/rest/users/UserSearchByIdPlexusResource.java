...
/**
 * REST resource that searches for users based on a users source and partial
 * user Id (user Id starts with xxx).
 *
 * @author bdemers
 */
@Singleton
...
public class UserSearchByIdPlexusResource extends
		AbstractUserSearchPlexusResource {
	public static final String USER_ID_KEY = "userId";

	public static final String RESOURCE_URI = "/user_search/{"
			+ USER_SOURCE_KEY + "}/{" + USER_ID_KEY + "}";
	...
	/**
	 * Returns a list of users in which the source and partial user id matches
	 * the parameters.
	 *
	 * @param sourceId
