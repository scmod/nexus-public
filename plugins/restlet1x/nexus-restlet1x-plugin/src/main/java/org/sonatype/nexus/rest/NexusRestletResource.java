...
public class NexusRestletResource extends RestletResource {
	...
	public NexusRestletResource(Context context, Request request,
			Response response, PlexusResource delegate) {
	...
	public Representation represent(Variant variant) throws ResourceException {
		try {
			...
			// if it's server error based on HTTP Code, but NOT when Nexus
			// throws a known 503
			// (see
