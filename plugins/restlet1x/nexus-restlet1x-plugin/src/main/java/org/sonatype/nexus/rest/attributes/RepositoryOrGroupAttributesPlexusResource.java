...
public class RepositoryOrGroupAttributesPlexusResource extends
		AbstractAttributesPlexusResource {
	public static final String RESOURCE_URI = "/attributes/{"
			+ AbstractAttributesPlexusResource.DOMAIN + "}/{"
	...
	public PathProtectionDescriptor getResourceProtection() {
		return new PathProtectionDescriptor("/attributes/*/**",
