...
/**
 * REST resource for listing the types of {@link UserManager} that are
 * configured in the system. Each {@link UserManager} manages a list of users
 * from a spesific source.
 *
 * @author bdemers
 */
@Singleton
...
public class UserLocatorComponentListPlexusResource extends
	...
	public PathProtectionDescriptor getResourceProtection() {
		return new PathProtectionDescriptor(getResourceUri(),
				"authcBasic,perms[security:componentsuserlocatortypes]");
	}
