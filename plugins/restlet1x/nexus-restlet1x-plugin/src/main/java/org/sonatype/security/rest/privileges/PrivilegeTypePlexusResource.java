...
/**
 * REST resource to retrieve the list of Privilege Types. Each type of privilege
 * that can be created is described by a {@link PrivilegeTypeResource}. Each
 * PrivilegeTypeResource lists the set of properties used to define a type of
 * privilege.
 *
 * @author bdemers
 */
...
public class PrivilegeTypePlexusResource extends
	...
	public PathProtectionDescriptor getResourceProtection() {
		return new PathProtectionDescriptor(getResourceUri(),
				"authcBasic,perms[security:privilegetypes]");
	}
	...
	public Object get(Context context, Request request, Response response,
		...
		List<PrivilegeDescriptor> privDescriptors = this.configurationManager
				.listPrivilegeDescriptors();
		...
		for (PrivilegeDescriptor privDescriptor : privDescriptors) {
			...
			for (PrivilegePropertyDescriptor propDescriptor : privDescriptor
