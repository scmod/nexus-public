...
/**
 * REST resource for retrieving a users by source. The sources is typically the
 * security realm the user belongs too.
 *
 * @author bdemers
 */
@Singleton
...
public class UserBySourcePlexusResource extends AbstractSecurityPlexusResource {
	...
	public static final String RESOURCE_URI = "/plexus_user/{"
	...
	public Object get(Context context, Request request, Response response,
		...
		User user;
		try {
			// TODO: remove the "all" we either need to move it down into the
			// SecuritySystem, or remove it, i vote
			// remove it.
