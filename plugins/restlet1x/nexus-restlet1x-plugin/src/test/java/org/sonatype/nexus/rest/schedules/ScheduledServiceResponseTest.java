...
public class ScheduledServiceResponseTest extends AbstractRestTestCase {

	@Test
	public void testNoScheduledService() throws Exception {
		...
		assert response.getData().getTypeId()
				.equals("Synchronize Repositories");
		assert response.getData().getSchedule().equals("none");
	}

	@Test
	public void testOnceScheduledService() throws Exception {
		...
		assert ((ScheduledServiceOnceResource) response.getData())
				.getStartDate().equals("1210651200000");
		assert ((ScheduledServiceOnceResource) response.getData())
				.getStartTime().equals("12:30");
	}

	@Test
	public void testDailyScheduledService() throws Exception {
		...
		assert ((ScheduledServiceDailyResource) response.getData())
				.getStartDate().equals("1210651200000");
		assert ((ScheduledServiceDailyResource) response.getData())
				.getRecurringTime().equals("12:30");
	}

	@Test
	public void testWeeklyScheduledService() throws Exception {
		...
		assert ((ScheduledServiceWeeklyResource) response.getData())
				.getStartDate().equals("1210651200000");
		assert ((ScheduledServiceWeeklyResource) response.getData())
				.getRecurringTime().equals("12:30");
	}
	...
	@Test
	public void testMonthlyScheduledService() throws Exception {
		...
		assert ((ScheduledServiceMonthlyResource) response.getData())
				.getStartDate().equals("1210651200000");
		assert ((ScheduledServiceMonthlyResource) response.getData())
				.getRecurringTime().equals("12:30");
	}
	...
	@Test
	public void testAdvancedScheduledService() throws Exception {
		...
		assert ((ScheduledServiceAdvancedResource) response.getData())
				.getCronCommand().equals("somecroncommand");
	}

	@Test
	public void testAdvancedScheduledServiceWithProperties() throws Exception {
		...
		assert ((ScheduledServicePropertyResource) response.getData()
				.getProperties().get(0)).getKey().equals("1");
		assert ((ScheduledServicePropertyResource) response.getData()
				.getProperties().get(0)).getValue().equals("true");
		assert ((ScheduledServiceAdvancedResource) response.getData())
				.getCronCommand().equals("somecroncommand");
	}
}
