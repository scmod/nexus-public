...
public class RemoveClassAttributeFromJsonStrings extends TestSupport {
	...
	public void testJsonStringWithClassAttribute() {
		...
		XStreamRepresentation representation = new XStreamRepresentation(
				this.xstreamJSON, text, MediaType.APPLICATION_JSON);
		...
		// System.out.println( "repoRouteResourceResponse: "+
		// repoRouteResourceResponse.getData().getPattern() );
	...
	//
	// XStreamRepresentation representation = new XStreamRepresentation(
	// this.xstreamJSON, text,
	// MediaType.APPLICATION_JSON );
	//
	// RepositoryRouteResourceResponse repoRouteResourceResponse =
