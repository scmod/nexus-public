...
public class UserToRolePRTest extends AbstractSecurityRestTest {

	private UserToRolePlexusResource getResource() throws Exception {
		return (UserToRolePlexusResource) this.lookup(PlexusResource.class,
				"UserToRolePlexusResource");
	}

	private ConfigurationManager getConfig() throws Exception {
		return this.lookup(ConfigurationManager.class);
	}

	public void testPutWithRoles() throws Exception {
	...
	public void testPutWithOutRoles() throws Exception {
		UserToRolePlexusResource resource = getResource();
		...
		try {
			...
			Assert.assertTrue(this
					.getErrorString((ErrorResponse) e.getResultObject(), 0)
					.toLowerCase().contains("role"));
		}
	}

	public void testPutUserNotInConfigYet() throws Exception {
		UserToRolePlexusResource resource = getResource();
	...
	public void testExternalRoleNotValidTest() throws Exception {
		...
		try {
			...
			String error = this.getErrorString(
					(ErrorResponse) e.getResultObject(), 0);
	...
	public void testPutWithRolesAndDelete() throws Exception {
		UserToRolePlexusResource resource = getResource();
		...
		// check config
		CUserRoleMapping mapping = this.getConfig().readUserRoleMapping(
				"jcoder", REALM_KEY);
	...
	public void testPutUserNotInConfigYetAndDelete() throws Exception {
		UserToRolePlexusResource resource = getResource();
