 ...
 */
public class PathProtectionDescriptorBuilderTest extends TestSupport {

	@Test
	public void pathAndFilters() {
		PathProtectionDescriptor descriptor = new PathProtectionDescriptorBuilder()
				.path("/foo").authcBasic().filter("perms", "foo").build();
	...
	public void pathMissing() {
		new PathProtectionDescriptorBuilder().authcBasic().build();
	}

	@Test
	public void singlePerm() {
		PathProtectionDescriptor descriptor = new PathProtectionDescriptorBuilder()
				.path("/foo").authcBasic().perms("foo").build();
	...
	public void multiplePerms() {
		PathProtectionDescriptor descriptor = new PathProtectionDescriptorBuilder()
				.path("/foo").authcBasic().perms("foo", "bar").build();

		log(descriptor.getPathPattern());
		assertEquals("/foo", descriptor.getPathPattern());

		log(descriptor.getFilterExpression());
		assertEquals("authcBasic,perms[foo,bar]",
