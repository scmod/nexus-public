...
public class DeepEqualsBuilder extends EqualsBuilder {
	...
	public static boolean reflectionDeepEquals(Object lhs, Object rhs,
		...
		DeepEqualsBuilder equalsBuilder = new DeepEqualsBuilder(testTransients,
				excludeFields);
		try {
	...
	private static void reflectionAppend(Object lhs, Object rhs, Class clazz,
		...
		while (clazz.getSuperclass() != null) {
				...
				if (!excludedFieldList.contains(f.getName())
					...
					try {
						...
						if (testClass != null && !hasEqualsMethod) {
							reflectionAppend(lhsChild, rhsChild, testClass,
									builder, useTransients, excludeFields);
						} else {
			...
			reflectionAppend(lhs, rhs, clazz, builder, useTransients,
					excludeFields);
		}
	}
